            ...
            <form data-toggle="validator" id="formCRUD">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" class="form-control" id="nama_tps" name="nama_tps"
                            placeholder="Nama TPS" required type="text">
                    </div>
                    <div class="form-group">
                        <label>Alamat TPS *)</label>
                        <input autocomplete="off" class="form-control" id="alamat_tps" name="alamat_tps"
                            placeholder="Alamat TPS" required type="text">
                    </div>
                </div>
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#nama_tps').val(data.nama_tps);
                $('#alamat_tps').val(data.alamat_tps);
            },
            error: function(response) {
                alert('Something went wrong. Please try again.');
            },
