        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Program') }}</h3>
            ...
            <form data-toggle="validator" id="formCRUD">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" class="form-control" id="nama_program" name="nama_program"
                            placeholder="Nama Program" required type="text">
                    </div>
                </div>
