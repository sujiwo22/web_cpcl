            ...
            <form data-toggle="validator" id="formCRUD">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" class="form-control" id="id_kecamatan" name="id_kecamatan"
                            placeholder="ID Kecamatan" required type="text">
                    </div>
                    <div class="form-group">
                        <label>Nama Kecamatan *)</label>
                        <input autocomplete="off" class="form-control" id="nama_kecamatan" name="nama_kecamatan"
                            placeholder="Nama Kecamatan" required type="text">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function ajaxList(id_provinsi,id_kota=null) {
        table.destroy();
