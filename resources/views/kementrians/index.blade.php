        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Kementrian') }}</h3>
            ...
            <form data-toggle="validator" id="formCRUD">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" class="form-control" id="nama_kementrian" name="nama_kementrian"
                            placeholder="Nama Kementrian" required type="text">
                    </div>
                    <div class="form-group">
                        <label>Singkatan *)</label>
                        <input autocomplete="off" class="form-control" id="singkatan" name="singkatan"
                            placeholder="Singkatan Nama Kementrian" required type="text">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function editData(id) {
        ...
        // var url = "/kementrian/show/"+id;
        var url = "{{ route('kementrian.show', ':id') }}";
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $('#nama_kementrian').val(data.nama_kementrian);
    ...
    function deleteData(id) {
        if (confirm("Apakah anda yakin akan menghapus data ini?")) {
            ...
            var url = "{{ route('kementrian.destroy', ':id') }}";
            url = url.replace(':id', id);
            $.ajax({
                method: 'delete',
                headers: {
